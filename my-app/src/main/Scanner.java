...
public class Scanner {
    ...
    private int line, column;//, last_col;
	...
	// stack to simulate the automata
	stack = new Stack<Integer>();
	// setting the automata transition function
	d = new int[13][11]; // 13 states (exclude error state transitions) and 11 "terminals"
	...
	lexeme = lexeme.substring(0, lexeme.length()-1); // truncate lexeme
    }
	...
	int state = ST_INIT; // set to the initial state
	// processing
	do{
	    runAFD(state);
